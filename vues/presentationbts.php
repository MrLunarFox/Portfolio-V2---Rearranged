...
<article>
    <br>
    <h1 class="Titrepage">Présentation du</h1>
    <h1 class="Titrepage">BTS SIO</h1>
    <br>
    <br>
    <h3 class="BTSSIO">QU'EST CE QUE LE BTS SIO ?</h3>
    <br>
    <div class="divp1">
        <p class="p1">SIO = Services informatiques aux organisations</p>
        <br>
        ...
        <p>Le BTS SIO se compose en 2 option différente : SLAM ou SISR.</p>
    </div>
    <br>
    <div id="col">
